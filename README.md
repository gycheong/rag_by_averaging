...
* [SBERT data for the sentence vectors](https://drive.google.com/file/d/1rLlnh2z_500l7bgURlMK62veZ1QXsACd/view?usp=sharing): extract them in the folder named "data" in the same directory as the notebook file
* The SBERT data can also be generated by the codes provided in the notebook.
